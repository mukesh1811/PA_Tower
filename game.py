...
while not done:
     ...
     #draw player
     pygame.draw.rect(screen, blue_color, pygame.Rect(place_right(participant_rect_length), place_down(participant_rect_width), participant_rect_length, participant_rect_width))
     

     #draw ai
     pygame.draw.rect(screen, orange_color, pygame.Rect(place_left(participant_rect_length), place_down(participant_rect_width),  participant_rect_length, participant_rect_width))
